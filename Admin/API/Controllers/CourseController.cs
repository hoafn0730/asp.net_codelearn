    ...
    public class CourseController : ControllerBase
    {
        ...
        public IActionResult Search([FromBody] Dictionary<string, object> formData)
        {
            try
            {
                ...
                if (formData.Keys.Contains("fr_RegistrationDate") && formData["fr_RegistrationDate"] != null && formData["fr_RegistrationDate"].ToString() != "")
                {
                ...
                if (formData.Keys.Contains("to_RegistrationDate") && formData["to_RegistrationDate"] != null && formData["to_RegistrationDate"].ToString() != "")
                {
